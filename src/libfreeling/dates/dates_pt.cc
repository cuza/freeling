...
#define ST_CH1b 40   // CH1: got valid hour (no min) from A (but could be a day number) ("um quarto")
...
#define TK_wquart    20    // wquart: "media" "pico" "algo" "poco"
#define TK_w1quart   42    // wquart: "um quarto"
#define TK_wy        21    // wy: "y"
#define TK_w1        43    // wy: "um" ("um quarto")
...
#define TK_wda       42    // wda: "da"

  ///////////////////////////////////////////////////////////////
  ///  Create a dates recognizer for Portuguese.
  ///////////////////////////////////////////////////////////////

  dates_pt::dates_pt(): dates_module(RE_DATE_PT, RE_TIME1_PT, RE_TIME2_PT, RE_ROMAN)
  {
    //Initialize token translation map
    tok.insert(make_pair(L"segunda-feira",TK_weekday));     tok.insert(make_pair(L"terça-feira",TK_weekday));
    tok.insert(make_pair(L"quarta-feira",TK_weekday));
    tok.insert(make_pair(L"quinta-feira",TK_weekday));    tok.insert(make_pair(L"sexta-feira",TK_weekday));
    ...
    tok.insert(make_pair(L"por",TK_wpor));  tok.insert(make_pair(L"para",TK_whacia));
    tok.insert(make_pair(L"sobre",TK_whacia)); tok.insert(make_pair(L"isso",TK_weso));      
    tok.insert(make_pair(L"e",TK_wy));      tok.insert(make_pair(L"menos",TK_wmenos));
    tok.insert(make_pair(L"de",TK_wde));    tok.insert(make_pair(L"do",TK_wdel));
    tok.insert(make_pair(L"a",TK_wa));      tok.insert(make_pair(L"ao",TK_wa));
    tok.insert(make_pair(L"em",TK_wen));    tok.insert(make_pair(L"ponto",TK_wpunto));
    tok.insert(make_pair(L"a",TK_wla));     tok.insert(make_pair(L"as",TK_wla));
    tok.insert(make_pair(L"o",TK_wel));     tok.insert(make_pair(L"da",TK_wda));
    tok.insert(make_pair(L",",TK_comma));   tok.insert(make_pair(L".",TK_dot));
    tok.insert(make_pair(L":",TK_colon));   tok.insert(make_pair(L"mês",TK_wmonth));
    tok.insert(make_pair(L"dia",TK_wday));  tok.insert(make_pair(L"mes",TK_wmonth)); 
    tok.insert(make_pair(L"ano",TK_wyear)); tok.insert(make_pair(L"presente",TK_wpast));
    tok.insert(make_pair(L"passado",TK_wpast)); tok.insert(make_pair(L"próximo",TK_wpast));
             
    tok.insert(make_pair(L"meia",TK_wquart)); tok.insert(make_pair(L"quarto",TK_w1quart));
    tok.insert(make_pair(L"pico",TK_wquart));  tok.insert(make_pair(L"um",TK_w1));
    tok.insert(make_pair(L"pouco",TK_wquart)); tok.insert(make_pair(L"tal",TK_wquart));

    tok.insert(make_pair(L"século",TK_wcentury)); tok.insert(make_pair(L"seculo",TK_wcentury));
    tok.insert(make_pair(L"sec.",TK_wcentury));  tok.insert(make_pair(L"s.",TK_wcentury));
    tok.insert(make_pair(L"séc.",TK_wcentury));
    ...
    tok.insert(make_pair(L"meianoite",TK_wmidnight)); tok.insert(make_pair(L"meio-dia",TK_wmidnight));
    tok.insert(make_pair(L"meiodia",TK_wmidnight));   tok.insert(make_pair(L"manhã",TK_wmorning)); 
    tok.insert(make_pair(L"tarde",TK_wmorning));       tok.insert(make_pair(L"madrugada",TK_wmorning));
    tok.insert(make_pair(L"noite",TK_wmorning));  tok.insert(make_pair(L"meia-noite",TK_wmidnight));
    ...
    tok.insert(make_pair(L"janeiro",TK_month));      tok.insert(make_pair(L"jan",TK_shmonth));
    tok.insert(make_pair(L"fevereiro",TK_month));    tok.insert(make_pair(L"fev",TK_shmonth));
    tok.insert(make_pair(L"março",TK_month));      tok.insert(make_pair(L"mar",TK_shmonth));
    tok.insert(make_pair(L"abril",TK_month));      tok.insert(make_pair(L"abr",TK_shmonth));
    tok.insert(make_pair(L"maio",TK_month));       tok.insert(make_pair(L"mai",TK_shmonth));
    tok.insert(make_pair(L"junho",TK_month));      tok.insert(make_pair(L"jun",TK_shmonth));
    tok.insert(make_pair(L"julho",TK_month));      tok.insert(make_pair(L"jul",TK_shmonth));
    tok.insert(make_pair(L"agosto",TK_month));     tok.insert(make_pair(L"ago",TK_shmonth));
    tok.insert(make_pair(L"setembro",TK_month)); tok.insert(make_pair(L"set",TK_shmonth));
    tok.insert(make_pair(L"outubro",TK_month));    tok.insert(make_pair(L"out",TK_shmonth));
    tok.insert(make_pair(L"novembro",TK_month));  tok.insert(make_pair(L"nov",TK_shmonth));
    tok.insert(make_pair(L"dezembro",TK_month));  tok.insert(make_pair(L"dez",TK_shmonth));
    tok.insert(make_pair(L"novem",TK_month));     tok.insert(make_pair(L"set",TK_shmonth));
    tok.insert(make_pair(L"dezem",TK_month));     tok.insert(make_pair(L"agos",TK_shmonth)); 
             
    // initialize map with month numeric values
    nMes.insert(make_pair(L"janeiro",1));      nMes.insert(make_pair(L"jan",1));
    nMes.insert(make_pair(L"fevereiro",2));    nMes.insert(make_pair(L"fev",2));
    nMes.insert(make_pair(L"março",3));      nMes.insert(make_pair(L"mar",3));
    nMes.insert(make_pair(L"abril",4));      nMes.insert(make_pair(L"abr",4));
    nMes.insert(make_pair(L"maio",5));       nMes.insert(make_pair(L"mai",5));
    nMes.insert(make_pair(L"junho",6));      nMes.insert(make_pair(L"jun",6));
    nMes.insert(make_pair(L"julho",7));      nMes.insert(make_pair(L"jul",7));
    nMes.insert(make_pair(L"agosto",8));     nMes.insert(make_pair(L"ago",8));
    nMes.insert(make_pair(L"setembro",9)); nMes.insert(make_pair(L"set",9));
    nMes.insert(make_pair(L"outubro",10));   nMes.insert(make_pair(L"out",10));
    nMes.insert(make_pair(L"novembro",11)); nMes.insert(make_pair(L"nov",11));
    nMes.insert(make_pair(L"dezembro",12)); nMes.insert(make_pair(L"dez",12));
    nMes.insert(make_pair(L"agos",8));
    nMes.insert(make_pair(L"novem",11));  nMes.insert(make_pair(L"dezem",12));  

    // initialize map with weekday numeric values
    nDia.insert(make_pair(L"segunda-feira",L"L")); nDia.insert(make_pair(L"terça-feira",L"M"));
    nDia.insert(make_pair(L"quarta-feira",L"X"));
    nDia.insert(make_pair(L"quinta-feira",L"J")); nDia.insert(make_pair(L"sexta-feira",L"V"));
    ...
    // State Hb
    trans[ST_Hb][TK_wde]=ST_Hc;  trans[ST_Hb][TK_wdel]=ST_AH; trans[ST_Hb][TK_wda]=ST_AH;
    // State Hc
  ...
  int dates_pt::ComputeToken(int state, sentence::iterator &j, sentence &se) const {
    wstring form,formU;
    int token,value;
    ...
    case ST_A: 
      ...
      if (token==TK_number && value>=1 && value<=31 && form!=L"uma" && form!=L"um") {
        token = TK_daynum;
      }
    ...
    case ST_FH1b:
      ...
      if (token==TK_number && value>=1 && value<=31 && form!=L"uma")
        // ("unha de xaneiro" is an invalid date)
        token = TK_daynum;
      break;
      // --------------------------------
    case ST_E:
    ...
    case ST_K:
      ...
      if (token==TK_number && form==L"uma")
        // ("ano un" is allright, but "ano unha" is an invalid date)
        token = TK_other;
      break;
      // --------------------------------
    case ST_S1:
  ...
  void dates_pt::StateActions(int origin, int state, int token, sentence::const_iterator j, dates_status *st) const {
    wstring form;
    int value;
    map<wstring,int>::const_iterator im;
    ...
    case ST_BH2:
      ...
      if (token==TK_minnum) {
      ...
      else if (token==TK_wquart || token==TK_w1quart) {
        if (form==L"meia") {
          st->minute=L"30";
        }
        else if (form==L"quarto") {
          // "y cuarto" vs "menos cuarto"
          if (origin==ST_EH1b) { // || origin==ST_CH1b) {
            st->minute=L"45";
            if (st->hour==L"1") st->hour=L"13"; // una menos veinte = 12:40
            st->hour = normalize(st->hour, -1);
          }
        ...
        value=util::wstring2int(st->rem[1]);
        // "y veinte" vs "menos veinte"
        if (origin==ST_EHb || origin==ST_EH1b) {
          value = 60-value;
          if (st->hour==L"1") st->hour=L"13"; // una menos veinte = 12:40
    ...
    case ST_GH1:
      ...
      if (token==TK_wampm) {
        ...
        if (form==L"manhã" || form==L"madrugada") st->meridian=L"am"; 
        else if (form==L"tarde" || form==L"noite") st->meridian=L"pm"; 
      }
      //else if (token==TK_wmidnight && hour=="??") {
      else if (token==TK_wmidnight) {
        if (form==L"meianoite" || form==L"meia-noite") {
          st->meridian=L"am";
          st->hour=L"00"; 
          st->minute=L"00";
        }
        else if (form==L"meiodia" || form==L"meio-dia") {
          st->meridian=L"pm";
    ...
    TRACE(3,L"State actions finished. ["+st->weekday+L":"+st->day+L":"+st->month+L":"+st->year
  ...
  void dates_pt::SetMultiwordAnalysis(sentence::iterator i, int fstate, const dates_status *st) const {
    list<analysis> la;
    wstring lemma;
